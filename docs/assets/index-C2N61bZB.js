(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const t of n.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&i(t)}).observe(document,{childList:!0,subtree:!0});function a(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(e){if(e.ep)return;e.ep=!0;const n=a(e);fetch(e.href,n)}})();const s=`<ul class="card-container" role="list">
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-content">
      ...
      <p class="project-description">MetaSound Branches is a plugin for Unreal Engine's audio environment, created in C++ and accompanied by extensive example patches.</p>
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-more">
      <ul>
          ...
          <li><a href="https://www.youtube.com/watch?v=bDwOI6jmXPo&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=3">‣ Game Animation Sample Project footstep extension</a></li>
          ...
          <li><a href="https://www.youtube.com/watch?v=34-I64onGtY&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=8">‣ Instrument Sandbox: web-based patcher</a></li>
      </ul>
    </div>
    <div class="project-video">
