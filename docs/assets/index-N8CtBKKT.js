(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function a(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(e){if(e.ep)return;e.ep=!0;const n=a(e);fetch(e.href,n)}})();const s=`<ul class="card-container" role="list">
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-content">
      <p class="project-description">
       Explore this playlist for examples of audio design, implementation, plugin development, and procedural music in Unreal Engine.
      </p>
      <hr>
    </div>
    <div class="project-more">
      <ul>
          <li><a href="https://www.youtube.com/watch?v=nDclcG0xYFg&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=1">‣ Unreal Engine footstep enhancement using data assets</a></li>  
          ...
          <li><a href="https://www.youtube.com/watch?v=Cw2E2UDpvCo&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=3">‣ Adaptive Music System (UE + Wwise)</a></li>
          <li><a href="https://www.youtube.com/watch?v=3I7n9CGu9TI&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=4">‣ Fortnite (sound redesign)</a></li>
          <li><a href="https://www.youtube.com/watch?v=OsNpiJt_E9Q&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=5">‣ The Transitions: foley concept mix</a></li>
          <li><a href="https://www.youtube.com/watch?v=HgudP5fzDWM&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=6">‣ MetaSound Branches plugin</a></li>
          <li><a href="https://www.youtube.com/watch?v=gC1We0uL63w&list=PLIKWa1FaZD5y24pnfeUiXkJ6GzWY5KAUE&index=7">‣ Procedural music: MetaSound with JSON</a></li>
      </ul>
    </div>
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-content">
      <p class="project-description">MetaSound Branches is a plugin for Unreal Engine's audio graph environment, featuring new node classes created in C++ and accompanied by extensive example patches.</p>
  ...
  <div class="project-header">
      <div class="project-thumbnail">
        <a href="https://matthewscharles.github.io/UE5-Wwise-Demo">
          <img src="thumbnails/blocks.png" alt="UE5 Wwise Demo: Blocks thumbnail">
        </a>
      </div>
      <div class="project-content">
        <h3><a href="https://matthewscharles.github.io/UE5-Wwise-Demo" class="project-name">UE5 / Wwise Demo: Blocks</a></h3>
        <div class="project-icons">
          <img src="icons/unreal-engine-svgrepo-com.svg" class="icon-category" alt="Unreal Engine logo">
          <img src="icons/wwise_logo_icon_249154.svg" class="icon-category" alt="Wwise logo">
        </div>
  ...
  <div class="project-content">
    <p class="project-description">This is a falling block game featuring an adaptive music soundtrack, created as a portfolio project with publicly available <a href=https://matthewscharles.github.io/UE5-Wwise-Demo>development notes</a>.</p>
    <p class="project-description">The game was created in Unreal Engine 5, with capability to switch between built-in audio and Wwise integration during play.</p>
  </div>
  <div class="project-video">
    <iframe src="https://www.youtube.com/embed/Cw2E2UDpvCo" 
      title="YouTube video player" 
      frameborder="0" 
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
      referrerpolicy="strict-origin-when-cross-origin" 
  ...
  <div class="video-title-box">
      <a href="https://www.youtube.com/embed/Cw2E2UDpvCo" target="_blank">Blocks demo</a>
  </div>
</li>
      ...
      <div class="project-more">
        <ul>
          <li><a href="https://www.youtube.com/watch?v=O2r3PW08sS8&feature=youtu.be">‣ Screenreader access demo</a></li>
            <li><a href="https://cycling74.com/projects/pipilan-gamelan-composition-real-time">‣ Related: Pipilan (2015)</a></li>
            <li><a href="./content/Charles_Matthews-Algorithmic_Thinking_and_Central_Javanese_Gamelan-Preprint.pdf">‣ Related: Chapter in Oxford Handbook of Algorithmic Music</a></li>
        </ul>
      </div>
    </div>
    <div class="project-video">
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-content">
      <p class="project-description">
        For the past ten years I have worked on improving access to music technology in collaboration with musicians, often through building new instruments.</p>
        <p class="project-description">In 2020 I helped found the non-profit organisation <a href="https://blurringtheboundaries.org/">Blurring the Boundaries Arts</a> with Gift Tshuma and David Bobier.</p>
        <p class="project-description">After stepping down as co-director in 2024, I continued as an external consultant including developing a MIDI-DMX system with new co-director Joel Dazé.</p>
      </p>
    </div>
    <hr>
    <div class="project-more">
      <ul>
        ...
        <li><a href="https://youtu.be/hGWN1ud2rX4?si=ZjZWY6_Jf-oGHNpy&t=439" rel="nofollow">‣ MIDI-DMX system (Blurring the Boundaries)</a></li>
      </ul>
    </div>
    <div class="project-video">
