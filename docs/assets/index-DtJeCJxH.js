...
<ul class="card-container" role="list">
  ...
  <li class="project-card" role="listitem">
    ...
    <div class="project-content">
      ...
      <p class="project-description">More information and development notes are available at the <a href="https://github.com/matthewscharles/metasound-branches/">GitHub Repository</a></p>
    </div>
    <div class="project-video">
